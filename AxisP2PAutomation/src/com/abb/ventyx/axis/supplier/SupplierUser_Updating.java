...
public class SupplierUser_Updating extends BaseTestCase {
	...
	public void selectUser() {
		...
		row = row - 1;
		USER_NO = driver.findElement(By.id(Users.USERNUMBER_LINKID + row))
				.getText();
	...
	public void checkDataOfUser() {
		...
		assertEquals(
				driver.findElement(By.id(Users.USER_ID)).getAttribute("value"),
				USER_ID);
		assertEquals(
				driver.findElement(By.id(Users.EMAIL_ID)).getAttribute("value"),
				EMAIL);

		WebElement userStatus = driver.findElement(By.id(Users.STATUS_ID))
		...
		WebElement radioNO = driver.findElement(By
				.cssSelector(Users.UPDATEPASSWORD_NO_CSS));
		assertEquals(radioNO.findElement(By.tagName("label")).getText(), "No");
		assertEquals(
				radioNO.findElement(By.tagName("input"))
						.getAttribute("checked"), "true");
		assertEquals(action.isElementPresent(By.id(Users.PASSWORD_ID)), false);
		assertEquals(action.isElementPresent(By.id(Users.CONFIMRPASSWORD_ID)),
				false);
		AllGROUP = table.getValueAllRowchecked(2,
				table.countRow(Users.USERGROUP_TABLE_CSS));
	}

	@Test(dependsOnMethods = "checkDataOfUser")
	public void updateUserSuccessfully() {
		driver.findElement(By.cssSelector(Users.UPDATEPASSWORD_YES_CSS))
	...
	public void addValidationUserID() throws InterruptedException {
		...
		action.checkValidationTextField(Users.USER_ID, USERID_EXISTING,
