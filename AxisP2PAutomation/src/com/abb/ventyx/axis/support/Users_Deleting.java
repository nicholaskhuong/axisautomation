...
public class Users_Deleting extends BaseTestCase{
	...
	@Test
	  public void checkScreen() {
  	 ...
  	 axisAdminMenu.click();
		 ...
		 WebElement deleteBtn0=driver.findElement(By.id(AxisAdministratorUsers.DELETE_ID+"0"));
	...
	public void deleteUserGroupClickNo () throws Exception {
	    ...
	    driver.findElement(By.id(AxisAdministratorUsers.DELETE_ID+"3")).click();  
	    String UserId=driver.findElement(By.id(AxisAdministratorUsers.ROW_ID+"3")).getText();
	    //Click No on dialog
	    ...
	    assertThat(deleteConfirm.getText(),containsString(Messages.DELETE_USER_CONFIRM));
	    ...
	    deleteNoBtn.click();
	    Thread.sleep(2000);
	    assertEquals(driver.findElement(By.id(AxisAdministratorUsers.ROW_ID+"3")).getText(), UserId);
	...
	public void deleteUserGroupClickYes () throws Exception {
	    ...
	    assertNotEquals(driver.findElement(By.id(AxisAdministratorUsers.ROW_ID+"3")).getText(), UserId);
	}
