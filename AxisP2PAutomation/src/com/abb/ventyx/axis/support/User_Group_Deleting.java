...
public class User_Group_Deleting extends BaseTestCase{
	...
	public void deleteUserGroupClickNo () throws Exception {
	    ...
	    driver.findElement(By.id(AxisSupportCustomerUserGroup.DELETE_ID+ (rowSelected-1))).click();  
	    //Click No on dialog
	    ...
	    assertThat(deleteConfirm.getText(),containsString(Messages.DELETE_USERGROUP_CONFIRM));
	    WebElement deleteNoBtn = (new WebDriverWait(driver, 10))
	  			.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(Messages.DELETE_NO)));
	    deleteNoBtn.click();
	    
	    WebElement rowDelete = (new WebDriverWait(driver, 10))
	  			.until(ExpectedConditions.presenceOfElementLocated(By.id(AxisSupportCustomerUserGroup.ROW_ID+ (rowSelected-1))));
	...
	public void deleteUserGroupClickYes () throws Exception {
	    ...
	    WebElement deleteYesBtn = (new WebDriverWait(driver, 10))
	  			.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(Messages.DELETE_YES)));
	    deleteYesBtn.click();
	    ...
	    assertEquals(flashMessage.getText(), Messages.USERGROUP_DELETE_SUCCESSFULLY);
	}
