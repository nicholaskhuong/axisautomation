...
public class Users_Updating extends BaseTestCase{
	...
	public void updateInvalidData () throws InterruptedException{ 
		WebElement row=driver.findElement(By.id(AxisAdministratorUsers.ROW_ID+"3"));
		row.click();	
		...
		assertEquals(screenTitle.getText(), AxisAdministratorUsers.SCREEN_UPDATE_TITLE);	
		//input invalid email
		...
		WebElement pwd = (new WebDriverWait(driver, 15))
				.until(ExpectedConditions.presenceOfElementLocated(By.id(AxisAdministratorUsers.PASSWORD_ID)));	
		...
		WebElement confirmPwd=driver.findElement(By.id(AxisAdministratorUsers.CONFIRM_PASSWORD_ID));
	...
	public void updateSuccessfully () throws InterruptedException{ 
	    ...
	    WebElement saveId=driver.findElement(By.id(AxisAdministratorUsers.SAVE_ID));
		saveId.click();
		WebElement warningMessage2 = (new WebDriverWait(driver, 10))
				.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(Messages.SUCCESS_MESSAGE)));
		assertEquals(warningMessage2.getText(), Messages.USER_UPDATE_SUCCESSFULLY);	
	...
	public void cancelWithoutData (){ 
		...
		WebElement row1=driver.findElement(By.id(AxisAdministratorUsers.ROW_ID+"1"));
		row1.click();	
	...
	public void cancelWithYes () throws InterruptedException{ 
		...
		WebElement email = (new WebDriverWait(driver, 15))
				.until(ExpectedConditions.presenceOfElementLocated(By.id(AxisAdministratorUsers.EMAIL_ID)));
