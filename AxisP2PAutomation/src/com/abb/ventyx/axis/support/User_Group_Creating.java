...
public class User_Group_Creating extends BaseTestCase {
	...
	public void addWithSelectedCustomerNoUserGroupName() throws Exception {
		 ...
		 * AxisSupportCustomerUserGroup.LIST_CSS); row =
	...
	public void cancelWithoutdata() throws InterruptedException {
		...
		(new WebDriverWait(driver, 20)).until(ExpectedConditions.presenceOfElementLocated(By.id(AxisSupportCustomerUserGroup.USER_CUSTOMER_ID)));
		WebElement screenTitle = driver.findElement(By.id(AxisSupportCustomerUserGroup.SCREEN_TITLE_ID));
