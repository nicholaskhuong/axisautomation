...
public class Profile_Update_Default_Profile_Step01_02 extends BaseTestCase {
	...
	// }
	//
	// @Test(dependsOnMethods = "clickFiterButtonOnMaintainCustomerScreen",
	// alwaysRun = true)
	...
	// "untickCheckBoxandSaveButtonOnModifyProfileScreen", alwaysRun = true)
	...
	//
	// // Step 6
	// @Test(dependsOnMethods = "tickCheckBoxOnModifyProfileScreen", alwaysRun =
	// true)
	...
	// }
	//
	// @Test(dependsOnMethods = "logoutAndLoginWithNewCustomerList2", alwaysRun
	// = true)
	...
	//
	// @Test(dependsOnMethods =
	// "openMaintainCustomerScreenWithAccountCustomer2", alwaysRun = true)
	...
	// }
	//
	// @Test(dependsOnMethods = "clickFiterButtonOnMaintainCustomerScreen2",
	// alwaysRun = true)
	...
	// }
	//
	// @Test(dependsOnMethods = "clickEditButtonOnMaintainCustomerScreen2",
	// alwaysRun = true)
	...
	// // Step 7
	// @Test(dependsOnMethods =
	// "verifyAuthorisedDocumentOnModifyProfileScreen2", alwaysRun = true)
	// public void logoutWithCustomerListSecondTime() {
	// action.signOut();
	// }
	//
	// @Test(dependsOnMethods = "logoutWithCustomerListSecondTime", alwaysRun =
	// true)
	...
	// }
	//
	// @Test(dependsOnMethods = "clickFiterButtonOnMaintainCustomer2", alwaysRun
	// = true)
	...
	// }
	//
	// @Test(dependsOnMethods = "clickEditButtonOnMaintainCustomer2", alwaysRun
	// = true)
	...
	//
	// // Step 8
	// @Test(dependsOnMethods = "verifyDataOnModifyProfileScreen2", alwaysRun =
	// true)
	...
	// }
	//
	// @Test(dependsOnMethods = "logoutAndLoginWithNewCustomerList3", alwaysRun
	// = true)
	...
	//
	// @Test(dependsOnMethods =
	// "openMaintainCustomerScreenWithAccountCustomer3", alwaysRun = true)
	...
	// }
	//
	// @Test(dependsOnMethods = "clickFiterButtonOnMaintainCustomerScreen3",
	// alwaysRun = true)
	...
	// }
	//
	// @Test(dependsOnMethods = "clickEditButtonOnMaintainCustomerScreen3",
	// alwaysRun = true)
