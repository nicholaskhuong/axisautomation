...
public class User_Administration_Updating extends BaseTestCase {
	...
	public static String userUpdate = "Taumato1";
	public static String emailUpdate = "Taumato1@abb.com";
	...
	public void clickFiterButtonOnUserScreen() {
		...
		table = new TableFunction(driver);
		table.clickFilterAndInputWithColumn(User_Administration_Creating.user, Users.USER_ID_FILTER, true);
	...
	public void inputInvalidPassword() {
		...
		userUpdate = String.format("Taumatoo%s", drand);
		emailUpdate = String.format("Taumatoo%s@abb.com", drand);
		action.waitObjVisible(By.id(Users.EMAIL_ID));
