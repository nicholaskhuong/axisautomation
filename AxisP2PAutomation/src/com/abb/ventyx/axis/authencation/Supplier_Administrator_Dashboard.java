...
@ALM(id = "496")
@Credentials(user = "supplier_user_1@abb.com", password = "Testuser1")
public class Supplier_Administrator_Dashboard extends BaseTestCase {
	ScreenAction action;
	TableFunction table;
	String supplierDashborad = "Supplier Dashboard";
	int milliseconds = 3000;
	String userName = "Administrator";
	String userID = "supplier_user_1@abb.com";
