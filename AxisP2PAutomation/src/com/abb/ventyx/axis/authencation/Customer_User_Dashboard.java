...
@ALM(id = "975")
@Credentials(user = "customer_user_2@abb.com", password = "Testuser1")
public class Customer_User_Dashboard extends BaseTestCase {
	ScreenAction action;
	TableFunction table;
	int milliseconds = 3000;
	String customerDashboard = "Customer Dashboard";
	String axisSupportPortal = "Axis Supplier Portal";
	String userName = "Customer 2";
	String userID = "customer_user_2@abb.com";
