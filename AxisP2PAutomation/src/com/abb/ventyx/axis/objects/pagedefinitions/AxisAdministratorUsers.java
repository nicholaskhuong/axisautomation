...
public class AxisAdministratorUsers {
	...
	public static final String TABLE_USERGROUP_CSS= "#content-component > div > div.v-panel-content.v-panel-content-borderless.v-panel-content-v-common-page-panel.v-scrollable > div > div.v-slot.v-slot-v-common-page-content-layout > div > div:nth-child(3) > div > div.v-slot.v-slot-v-horizontal-layout-with-border > div > div > div > div > div.v-grid-tablewrapper > table";
	...
	public static final String FILTER_ID="filterField";
	public static final String UPDATED_PASSWORD_ID="updatePasswordOptionGroup";
	public static final String USER_TABLE_CSS="#content-component > div > div.v-panel-content.v-panel-content-borderless.v-panel-content-v-common-page-panel.v-scrollable > div > div > div.v-slot.v-slot-v-common-page-content-layout > div > div > div > div > div > div > div > div.v-grid-tablewrapper > table";
	public static final String USER_ID_NAMECOLUMN="User ID";
