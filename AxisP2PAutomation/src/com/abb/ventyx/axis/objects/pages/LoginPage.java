...
public class LoginPage extends BasePage{
	...
	public void login(String url,String username, String password){
		...
		WebElement userNameTextField = (new WebDriverWait(driver, 30)).until(ExpectedConditions.presenceOfElementLocated(By.id(LoginPageDefinition.USERNAME_TEXT_FIELD_ID)));
